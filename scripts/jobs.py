...
ACTIONS: dict[str, dict] = {
    ...
    "generate": {"label": "生成资产", "args": ["--asset", "--draft", "--draft-limit", "--question"],
                 "desc": "llms.txt / JSON-LD / 片段 / 大纲"},
    "auto-drafts": {"label": "自动内容队列", "args": ["--limit"],
                    "desc": "只生成未重复的 AI 初稿，永不自动发布", "slow": True},
    "daily-content": {"label": "生成并推送 CMS 草稿", "args": ["--limit"],
                      "desc": "自动生成未重复初稿并创建 WisGate CMS Draft，不公开发布", "slow": True},
    "lint":     {"label": "初稿风险检查", "args": [], "desc": "查 AI 初稿的编造风险"},
    "smoke":    {"label": "上线后验收", "args": ["--url", "--question"],
                 "desc": "只读检查看板、工作台和抽取块预检"},
